		...
		Plugins: []manifest.RegistryEntry{
			{
				...
				JinCompat:      ">=0.7.0",
				LatestVersion:  "0.3.1",
				Versions:       []manifest.RegistryVersion{{Version: "0.3.1", SHA: "abc123", Tag: "v0.3.1"}},
				FirstClaimedAt: time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
			...
			},
			{
				...
				JinCompat:      ">=0.7.0",
				LatestVersion:  "1.0.0",
				Versions:       []manifest.RegistryVersion{{Version: "1.0.0", SHA: "def456", Tag: "v1.0.0"}},
				FirstClaimedAt: time.Date(2026, 2, 1, 0, 0, 0, 0, time.UTC),
